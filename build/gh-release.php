...
$owner = 'davidtsadler';
$repo = 'ebay-sdk-bulk-data-exchange';
...
assert(file_exists(__DIR__ . '/artifacts/dts-bulk-data-exchange.zip'));
assert(file_exists(__DIR__ . '/artifacts/dts-bulk-data-exchange.phar'));
...
$client->post(
    $uploadUrl . '/assets?name=dts-bulk-data-exchange.zip',
    array('Content-Type' => 'application/zip'),
    fopen(__DIR__ . '/artifacts/dts-bulk-data-exchange.zip', 'r')
)->send();

$client->post(
    $uploadUrl . '/assets?name=dts-bulk-data-exchange.phar',
    array('Content-Type' => 'application/phar'),
    fopen(__DIR__ . '/artifacts/dts-bulk-data-exchange.phar', 'r')
)->send();
