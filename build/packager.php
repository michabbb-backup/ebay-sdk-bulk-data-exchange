...
$autoLoader = 'dts-bulk-data-exchange-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-bulk-data-exchange.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-bulk-data-exchange.phar', null, $autoLoader);
